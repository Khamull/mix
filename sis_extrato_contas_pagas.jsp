...
rs = st.executeQuery(lancamentos.RecebidosporClienteSoma(clienteID, dataBusca));
rs01 = st01.executeQuery(lancamentos.RecebidosporClientePorData(clienteID, dataBusca));
...
<table align="center" width="350">
 ...
 <tr>
  ...
  <table align="center" width="348" cellpadding="0" cellspacing="0">
   <tr>
    <td align="center"><strong><%=rs02.getString("nomeFantasia") %></strong></td>
   </tr>
   <tr>
    <td align="left">End: <%=rs02.getString("rua") %>, <%=rs02.getString("numero") %></td>
   </tr>
   <tr>
    <td align="left">Bairro: <%=rs02.getString("bairro") %></td>
   </tr>
   <tr>
    <td align="left">Cidade: <%=rs02.getString("cidade") %> - <%=rs02.getString("uf") %></td>
   </tr>
   <tr>
    <td align="left">Tel: <%=rs02.getString("telefone") %></td>
   </tr>
   <tr>
    <td align="left">CNPJ: <%=rs02.getString("cnpj") %></td>
   </tr>
   <tr>
    <td align="left">Insc. Estadual: <%=rs02.getString("inscEstadual") %></td>
   </tr>
   <tr>
    <td height="25"></td>
   </tr>
 ...
 <%}else{ %>
 <tr>
  <td align="center">RECEBEMOS: <%=total %></td>
 </tr>
 <%} %>
 <tr>
 ...
 <tr>
  ...
  <table align="center" width="340">
   <tr bgcolor="#EEEEEE">
    <td width="104" align="left"><strong>N&deg; Venda</strong></td>
    <td width="107" align="center"><strong>Data Venda</strong></td>
    <td width="113" align="right"><strong>Valor</strong></td>
   </tr>
