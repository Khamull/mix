...
rs = st.executeQuery(servicoProduto.listaProdutosOS(request.getParameter("OS"), request.getParameter("Ano")));
%>
...
<tr>
 <td align="left">N&deg; O.S. <%=rs02.getString("OS") %>/<%=rs02.getString("anoServico").substring(0,4) %></td>
...
<tr>
 <td align="left" colspan="3">e-mail: <%=rs01.getString("email") %></td>
</tr>
<%if(rs04.next()){ %>
<tr>
...
%>
 ...
 <tr>
  <td colspan="2" align="left"><%=rs.getString("nome")%></td>
  </tr>
 <tr>
  <td colspan="2" align="left">Valor: <%=preco%></td>
...
<tr>
 <td align="left">N&deg;: <%=rs02.getString("OS")%>/<%=rs02.getString("anoServico").substring(0,4) %></td>
